<template>
  <div class="wraps">
    <div>
      ...
      <el-button style="margin-left: 10px" @click="init">搜索</el-button>
      <el-button type="primary" style="margin-left: 10px" @click="openDialog">添加</el-button>
    </div>
  ...
  <el-dialog v-model="isShowTag" title="添加tag">
    ...
    <template #footer>
      <el-button type="primary" @click="addTa">确定</el-button>
    </template>
  </el-dialog>
</template>
